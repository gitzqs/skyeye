    ...
    <div id="pad-wrapper" class="new-user">
        ...
        <div class="row form-wrapper">
            ...
            <div class="col-md-9 with-sidebar">
                <div class="container">
                    <form class="new_user_form" action="/recharge/save" method="post" style="font-size: 120%">
                        ...
                        <div class="col-md-12 field-box">
                            <label>设备编码：</label>
                            <label>${equipment.equipCode}</label>
                        </div>
                        <div class="col-md-12 field-box">
                            <label>公司名称：</label>
                            <label>${equipment.company.companyName}</label>
                        </div>
                        <div class="col-md-12 field-box">
                            <label>服务周期/天：</label>
                            <input class="form-control" style="width: 30%" type="text" name="serviceDay" value="${equipment.serviceDay}"/>
                        </div>
                        <div class="col-md-11 field-box actions" style="text-align: left">
