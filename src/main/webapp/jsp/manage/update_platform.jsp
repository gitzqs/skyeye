    ...
    <div id="pad-wrapper" class="new-user">
        ...
        <div class="row form-wrapper">
            ...
            <div class="col-md-9 with-sidebar">
                <div class="container">
                    <form class="new_user_form" action="/platform/save" method="post">
                        <input name="id" type="hidden" value="${platform.id}">
                        <c:if test="${platform!= null && platform.id!=null}">
                        
                            <input name="platform.id" type="hidden" value="${platform.id}">
                        </c:if>
                        <c:if test="${platform!= null && platform.name!=null}">
                            <div class="col-md-12 field-box">
                            <label>平台名称:</label>
                            	<input class="form-control" type="text" name="name" value="${platform.name}"/>
                        	</div>
                        </c:if>
